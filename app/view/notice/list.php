                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped">
                                ...
                                foreach ($rows as $val) {
                                    ...
                                    // 댓글 들여쓰기
                                    if ($val['n_depth'] > 0) {
                                        $indent = str_repeat('&nbsp;&nbsp;', $val['n_depth']) .'<i class="fa fa-angle-right"></i> ';
                                    } else {
                                        $indent = '';
                                    }
                                    ...
                                    $regDate = date('Y-m-d', strtotime($val['n_reg_date']));
                                    ?>

                                    <tr>
                                        <td><?=$row_no?></td>
                                        <td class="ellipsis-base ellipsis-title"><?=$title?></td>
                                        <td class="ellipsis-base ellipsis-name"><?=$val['n_name']?></td>
                                        <td><?=$regDate?></td>
                                        <td><?=$val['n_count']?></td>
                                    </tr><?php
                                } ?>
